...
{
  public class SearchTipHandler : IUpdateHandler
  {
    public static bool CanHandle(IUpdateContext context)
    {
      ...
      switch (updateType)
      {
        ...
        {
          return UpdateHandlerExtensions.IsCallbackCommand(context?.Update?.Message, Constants.SearchTipCallbackCommand);
        }
        case UpdateType.CallbackQuery:
        {
          return UpdateHandlerExtensions.IsCallbackCommand(context?.Update?.CallbackQuery, Constants.SearchTipCallbackCommand);
        }
      }
